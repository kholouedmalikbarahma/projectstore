...
<head>
    ...
    <title> @yield('titlle', 'Monica') - {{ Config('app.name') }}</title>
            ...
            <div class="row s-header__inner width-sixteen-col">
                ...
                <nav class="s-header__nav">
                    ...
                    <ul class="s-header__menu-links">
                        ...
                        <li class="current"><a href="{{route('pages',['name'=>'contact'])}}">Contact</a></li>
            ...
            <section class="s-pageheader pageheader">
                <div class="row">
                    <div class="column xl-12">
                        <h1 class="page-title">
                            <span class="page-title__small-type text-pretitle">@yield('titlle')</span>
                            @yield('name')
                        </h1>
                    </div>
                </div>
                            ...
                            <div class="swiper-container testimonials__slider page-slider">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="testimonials__slide swiper-slide">
                                        ...
                                        <div class="testimonials__author">
                                            <img src="{{asset('images/avatars/user-04.jpg')}}" alt="Author image"class="testimonials__avatar">
                                            <cite class="testimonials__cite">
                                    ...
                                    <div class="testimonials__slide swiper-slide">
                                        <p>
                                            Nisi dolores quaerat fuga rem nihil nostrum. Molestiae incidunt consequatur
                                            quis ipsa autem nam sit enim magni.
