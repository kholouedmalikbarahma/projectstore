...
<head>
    ...
    <link rel="{{asset('icon')}}" type="image/png" sizes="32x32" href="{{asset('favicon-32x32.png')}}">
    <link rel="{{asset('icon')}}" type="image/png" sizes="16x16" href="{{asset('favicon-16x16.png')}}">
    <link rel="{{asset('manifest')}}" href="{{asset('site.webmanifest')}}">
            ...
            <div class="row s-header__inner width-sixteen-col">
                ...
                <div class="s-header__block">
                    <div class="s-header__logo">
                        <a class="logo" href="{{route('home',['name'=>'index'])}}">
                ...
                <nav class="s-header__nav">
                    ...
                    <ul class="s-header__menu-links">
                        <li><a href="{{route('pages',['name'=>'about'])}}">About</a></li>

                        <li><a href="{{route('pages',['name'=>'services'])}}">Services</a></li>


                        <li><a href="{{route('pages',['name'=>'journal'])}}">Journal</a></li>
                        <li><a href="{{route('pages',['name'=>'contact'])}}">Contact</a></li>
                    </ul> <!-- s-header__menu-links -->

                    <div class="s-header__contact">
                        <a href="{{route('pages',['name'=>'contact'])}}" class="btn btn--primary s-header__contact-btn">Let's Work Together</a>
                    ...
                    <div class="column lg-12 s-intro__content-inner grid-block">
                        ...
                        <div class="s-intro__content-media">
                            <div class="s-intro__content-media-inner">
                                <img src="{{asset('images/intro-bg.jpg')}}" srcset="images/intro-bg.jpg 1x, images/intro-bg@2x.jpg 2x" alt="">
                                <div class="lines">
                                    <span></span>
                                </div>
                            </div>
                ...
                <div class="row s-about__content width-sixteen-col">
                    <div class="column grid-block grid-section-split">
                        ...
                        <div class="s-about__content-btn grid-section-split__bottom">
                            <a href="{{route('pages',['name'=>'about'])}}" class="btn btn--stroke u-fullwidth">More About Me</a>
                ...
                <div class="row s-expertise__content width-sixteen-col">
                    <div class="column xl-12 grid-block grid-section-split">
                        ...
                        <div class="s-expertise__content-btn grid-section-split__bottom">
                            <a href="{{route('pages',['name'=>'services'])}}" class="btn btn--stroke u-fullwidth">View All Services</a>
                        </div> <!-- end s-about__content-btn -->
            ...
            <div class="row row-x-center text-center">
                <div class="column xl-8 lg-12">
                    ...
                    <div class="s-cta__content">
                        ...
                        <a href="{{route('pages',['name'=>'contact'])}}" class="btn btn--primary">Let's Work Together</a>
                    </div>
                ...
                <div class="column xl-12 grid-block">
                    ...
                    <div class="grid-full s-journal__content-main grid-list-items">
                        ...
                        <div class="grid-list-items__item blog-card">
                            <div class="blog-card__header">
                                <div class="blog-card__cat-links">
                                    <a href="{{route('pages',['name'=>'journal'])}}">Productivity</a>
                                </div>
                        ...
                        <div class="grid-list-items__item blog-card">
                            <div class="blog-card__header">
                                <div class="blog-card__cat-links">
                                    <a href="{{route('pages',['name'=>'journal'])}}">SEO</a>
                                </div>
        ...
        <footer class="s-footer">
            <div class="row s-footer__content">
                ...
                <div class="column xl-3 lg-6 md-12 s-footer__block s-footer__site-links">
                    <h3>Site Links</h3>
                    <ul class="link-list">
                        <li><a href="{{route('home',['name'=>'index'])}}">Home</a></li>
                        <li><a href="{{route('pages',['name'=>'services'])}}">Services</a></li>
                        <li><a href="{{route('pages',['name'=>'journal'])}}">Journal</a></li>
                        <li><a href="{{route('pages',['name'=>'about'])}}">About</a></li>
                        <li><a href="{{route('pages',['name'=>'contact'])}}">Contact</a></li>
